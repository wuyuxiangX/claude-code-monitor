...
export function RE_INPUT_TOKENS() { return new RegExp(RE_INPUT_TOKENS_SRC.source, "g"); }
export function RE_OUTPUT_TOKENS() { return new RegExp(RE_OUTPUT_TOKENS_SRC.source, "g"); }
export function RE_CACHE_READ() { return new RegExp(RE_CACHE_READ_SRC.source, "g"); }
export function RE_CACHE_CREATION() { return new RegExp(RE_CACHE_CREATION_SRC.source, "g"); }
export function RE_MODEL() { return new RegExp(RE_MODEL_SRC.source, "g"); }
export function RE_TYPE_ASSISTANT() { return new RegExp(RE_TYPE_ASSISTANT_SRC.source, "g"); }
export function RE_TYPE_USER() { return new RegExp(RE_TYPE_USER_SRC.source, "g"); }
